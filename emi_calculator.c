/*
Problem Statement: Create a C program to compute the monthly EMI, total payment, and total interest 
on a loan based on loan amount, interest rate, and tenure using the standard EMI formula.
*/
