/*
Problem Statement: Develop a C program that simulates a restaurant menu where the user can choose from Starters, Main Course, 
and Sweets, place multiple orders, and receive a final bill with CGST and SGST calculations.
*/
