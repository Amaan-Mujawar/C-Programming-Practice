/*
Problem Statement: Write a C program to compute gross salary of an employee by calculating HRA, 
TA, MA, SA, and PF from basic salary and then display a formatted salary slip.
*/
