/*
Problem Statement: Write a C program to print a mirrored 'Z' shaped pattern (diagonal from top-left to bottom-right) 
using asterisks, with input size validation (minimum size = 3).
*/
