/*
Problem Statement: Write a C program that calculates an electricity bill based on tiered unit pricing, adds a fixed charge and GST, 
and displays a detailed bill including customer info.
*/
