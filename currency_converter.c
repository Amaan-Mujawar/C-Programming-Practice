/*
Problem Statement: Write a C program that converts an amount from one currency 
to another (e.g., Rupees to Dollars, Euros, Pounds, etc.) using fixed exchange 
rates with a menu-driven interface that allows the user to select and perform 
conversions.
*/
