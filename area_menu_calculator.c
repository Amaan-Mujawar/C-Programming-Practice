/*
Problem Statement: Write a C program that provides a menu to calculate the area of a circle, triangle, 
or rectangle based on user choice. The user should be able to repeat calculations.
*/
